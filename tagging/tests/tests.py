    ...
    def test_with_invalid_input_mix_of_string_and_instance(self):
        try:
            ...
            raise self.failureException(
                "the wrong type of exception was raised: type [%s] value [%s]"
                % (str(type(e)), str(e))
            )
        else:
            raise self.failureException(
...
class TestCalculateCloud(TestCase):
    ...
    def test_calculate_tag_weight(self):
        self.assertEqual(_calculate_tag_weight(10, 20, LINEAR), 10)
        self.assertEqual(_calculate_tag_weight(10, 20, LOGARITHMIC), 15.37243573680482)

    def test_calculate_tag_weight_invalid_size(self):
        self.assertEqual(_calculate_tag_weight(10, 10, LOGARITHMIC), 10.0)
        self.assertEqual(_calculate_tag_weight(26, 26, LOGARITHMIC), 26.0)
    ...
    TEMPLATES=[
        {
            ...
            "OPTIONS": {"loaders": ("tagging.tests.utils.VoidLoader",)},
        }
    ],
)
